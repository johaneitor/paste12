...
# entry_main v2: primero intenta backend/app/run y SI FALTA, usa wsgiapp._resolve_app()
...
git commit -m "ops: entry_main resolver v2 — fallback a wsgiapp._resolve_app para compatibilidad legacy"
